...
class UsersController extends Controller
{
    public function index()
    {
        ...
        if (!$user->jabatan || !$user->nip || !$user->id_unit || !$user->name || !$user->phone || !$user->email) {
            return redirect(url('user/account/edit'));
        } else {
    ...
    public function account()
    {
        ...
        return view('users.account', ['Data' => $data, 'unit' => $unit]);
    }
    ...
    public function validateProfil(array $data)
    {
        ...
        return Validator::make($data, [
            ...
            'nip' => 'required|max:200|unique:users,nip,' . $data['id'],
            'unit' => 'required ',
            'jabatan' => 'required|max:200',
            'phone' => 'required|max:200|unique:users,phone,' . $data['id'],
            'password' => 'required',
