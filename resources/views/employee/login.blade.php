            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background-color: azure">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user"  method="POST" action='{{ url("login/employee") }}' aria-label="{{ __('Login') }}">
                                        @csrf
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="/password/resetemployee">Lupa Password?</a>
