                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 ">
                                <div class="p-5">
                                    ...
                                    <form class="user" method ="post"action="{{ route('admin.password.request') }}" aria-label="{{ __('Login') }}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="password-confirm" type="password"  class="form-control form-control form-control-user"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.password.request') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password2" class="col-md-4 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
