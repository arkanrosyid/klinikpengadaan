                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ url('register/employee') }}" >
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="/passowrd/resetemployee">Lupa Password?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="/login/pegawai">Sudah punya akun? Login sekarang!</a>
                            </div>
                        </div>
                    </div>
                </div>
