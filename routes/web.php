...
Route::get('/daftar', [RegisterController::class, 'showRegistrationForm'])->middleware('guest');
Route::post('/daftar/create', [RegisterController::class, 'create'])->middleware('guest');
